...
describe('Testing the messages Endpoint', function () {
  describe('Testing the save/send mail Endpoint', function () {
    ...
    it('should throw a validation error for bad email input',
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    ...
    it('should save a message as draft and protect from sending message to self',
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
  ...
  describe('Testing the get specific users email by Id Endpoint', function () {
    ...
    it('should throw a 400 error bad url',
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
      ...
      return regeneratorRuntime.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              _context12.next = 2;
              return _chai.default.request(_index.default).get('/api/v1/messages/_').set('x-auth-token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEiLCJ1c2VybmFtZSI6Im90YWlnYmUiLCJlbWFpbCI6Im90YWlnYmVAZXBpY21haWwuY29tIiwiaWF0IjoxNTUyOTY3MDY3fQ.-9Gv6CLrGsoSTxeBSnd24Dse_1uKE5Gu_6x6IhOq9Q4');
      ...
      return regeneratorRuntime.wrap(function _callee15$(_context15) {
        while (1) {
          switch (_context15.prev = _context15.next) {
            case 0:
              _context15.next = 2;
              return _chai.default.request(_index.default).delete('/api/v1/messages/bar').set('x-auth-token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEiLCJ1c2VybmFtZSI6Im90YWlnYmUiLCJlbWFpbCI6Im90YWlnYmVAZXBpY21haWwuY29tIiwiaWF0IjoxNTUyOTY3MDY3fQ.-9Gv6CLrGsoSTxeBSnd24Dse_1uKE5Gu_6x6IhOq9Q4');
